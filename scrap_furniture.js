...
for (let i = 1; i <= 27; i++) {
    request(
        {
            method: 'GET',
            url: `http://api.scraperapi.com/?key=078ce04524dee4c07619efb2a5e134b4&url=${encodeURIComponent("https://trangvangvietnam.com/srch/vi%E1%BB%87t_nam/n%E1%BB%99i_th%E1%BA%A5t.html?page="+i)}`,
            headers: {
